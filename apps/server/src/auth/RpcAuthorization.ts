...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.uiControlConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.uiControlRespond]: AuthOrchestrationOperateScope,
  [WS_METHODS.uiControlFocusHost]: AuthOrchestrationOperateScope,
